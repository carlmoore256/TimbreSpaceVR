...
public class GrainModel : MonoBehaviour
{
    ...
    private void OnWindowParameterUpdate(int windowSize, int hopSize) {
        ...
        featureExtractor = new AudioFeatureExtractor(this.parameterHandler.WindowSize, this.parameterHandler.HopSize);
    ...
    private void SpawnGrain(GrainAudioFeatures features)
    {
        ...
        grain.Initialize(features, parameterHandler, grainModelPlayback.RegisterPlaybackEvent);
